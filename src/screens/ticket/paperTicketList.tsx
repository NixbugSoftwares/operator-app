...
return (
  ...
  >
    ...
    <Box
      sx={{
          flex: selectedPaperTicket ? { xs: "0 0 100%", lg: "0 0 65%" } : "0 0 100%",
          maxWidth: selectedPaperTicket ? { xs: "100%", lg: "65%" } : "100%",
  ...
  >
    ...
    {/* 🔹 Mobile Details Dialog - Show ONLY on xs/sm */}
    <Dialog
      open={Boolean(selectedPaperTicket)}
      onClose={() => setSelectedPaperTicket(null)}
      fullScreen
